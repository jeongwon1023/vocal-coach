    ...
    *,
    ...
    st.markdown(
        ...
        <div class="vc-app-card vc-record-card">
            ...
            <p class="vc-app-card-desc">추천 · 가장 빠른 방법 — 완곡(3~4분)도 OK. 길면 <b>1절(2분 30초)</b>부터 우선 진단해 드려요.</p>
            <div class="vc-record-hero-badge">① 녹음 → ② 들어보기 → ③ 분석 시작</div>
        </div>
        """
    )
...
def render_file_upload_fallback(*, disabled: bool = False) -> tuple:
    """파일 업로드 · 샘플 (접이식 카드). Returns (uploaded, use_sample)."""
    uploaded = None
    use_sample = False
